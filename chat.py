...
class Chat:
    def __init__(self):
        self.sessions = {}
        self.users = {}
        self.users['fariz'] = {'nama': 'fariz',
                               'password': 'test', 'incoming': {}, 'outgoing': {}}
        self.users['ivan'] = {'nama': 'ivan',
                              'password': 'test', 'incoming': {}, 'outgoing': {}}
        self.users['ai'] = {'nama': 'ai',
                            'password': 'test', 'incoming': {}, 'outgoing': {}}
...
if __name__ == "__main__":
    j = Chat()
    sesi = j.proses("auth fariz test")
    # print sesi

    tokenid = sesi['tokenid']
    # print j.proses("send {} henderson hello gimana kabarnya son " . format(tokenid))

    # print j.get_inbox('fariz')
